...
git clone --single-branch --branch "$TARGET_BRANCH_SDK_MAIN" "https://$USER_NAME:$API_TOKEN_GITHUB@github.com/$DESTINATION_REPOSITORY_USERNAME/$TARGET_REPOSITORY_NAME_GO_SDK.git" "$CLONE_DIR/$TARGET_REPOSITORY_NAME_GO_SDK"
